            ...
            <div class="title-header-product">
                ...
                if (isset($name_type)) {
                    echo "
                        <span>Danh mục</span>
                        <span>/</span>
                <span><a href='#'>$name_type</a></span>
                ";
                } else {
                    echo "
                        
                <span>Kết quả tìm kiếm cho <b>$name_search</b></span>
                ";
                }
                ?>
        ...
        <div class="container">
            <div class="row">
                <div class="banner-all">
                    <img src='../../content/image/different/banner-<?= $banner ?>.webp' alt="" width="100%">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-9">
                                ...
                                <div class="product">
                                    ...
                                    <div class="btn-product-cart">
                                        <button class="button-cart">
                                            <a class="button-content" href="' . $CONTROLLER_URL . '/addToCart.php?id_product=' . $product['id_product'] . '&shop-cart">
                                            THÊM VÀO GIỎ
                                            </a>
                                        </button>
                                    </div>
