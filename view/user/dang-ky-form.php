...
<head>
    ...
    <link rel="stylesheet" href="<?= $CONTENT_URL ?>/css/form-register.css">
...
<body>
    ...
    <div class="wrapper wrapper--w680">
        <div class="card card-4">
            <div class="card-body">
                <h2 class="title">Fill out the form below to register</h2>
                <form method="POST" action="<?= $ACCOUNT_URL ?>/register.php">

                    <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                <input class="input--style-4" type="text" name="last_name" placeholder="Last name" required>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                    ...
                    <div class="input-group">
                        <input class="input--style-4" type="text" name="id_user" placeholder="User name" required>
                    </div>
                    <div class="input-group">
                        <input class="input--style-4" type="password" name="pass" placeholder="Password" required>
                    </div>
                    <div class="input-group">
                        <input class="input--style-4" type="text" name="email" placeholder="Email" required>
                    </div>
                    <div class="input-group">
                        <input class="input--style-4" type="text" name="phone" placeholder="Number Phone" required>
                    </div> <label class="anim">
                        <span>Already an account?<a href="dang-nhap.php">Login here</a></span>
                    </label>

                    <div class="p-t-15">
                        <!-- <button class="btn btn--radius-2 btn--blue" type="submit" name="register">Submit</button> -->
                        <!-- <input type="submit" value="Đăng Ký" name="register" class="btn btn--radius-2 btn--blue" style="width: max-content;"> -->
                    </div>
                    <div class="submit-agileits">
                        <input type="submit" value="Register" name="register" class="btn--blue" style="width: max-content;">
                    </div>
                </form>
            </div>
</body>
