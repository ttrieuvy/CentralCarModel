        ...
        <div class="wthree-form">
            ...
            <!-- <form action="<?= $ACCOUNT_URL ?>/checkLogin.php" method="post"> -->
                <div class="form-sub-w3">
                    <input type="text" name="id_user" placeholder="Username" required=""  <?= isset($id_user) ? 'value = '.$id_user.' readonly' : ''?>>
                </div>
                <?php
                if(isset($check2)){
                    echo '
                ...
                if (isset($MESSAGE)) {
                    echo '<p  style="text-align: center;font-weight:bold;">' . $MESSAGE . '</p>';
                }

                ?>
                <label class="anim">
                    <a href="dang-nhap.php">Log in</a>
                </label>
                <div class="clear"></div>
